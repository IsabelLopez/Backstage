            ...
            <Layout>
              <div className="contenido">
                ...
                <div className="flex-box-half">
                  <div className="one-half-flex one-half-text">
                  ...
                  <div className="one-half-flex img-side one-half-img" id="relative-side">
              ...
              <div className="flex-box-half column-reverse" id="historia-second">
                  <div className="one-third-flex height-auto circle-img-teacher" id="relative-side" >
                    <img src={Main} alt="" class="imgHistoria-teacher" />
                    <img src={Circle} alt="" class="imgHistoria-circle" />

                  </div>
                  <div className="two-third-flex" id="no-pad-bottom">
                    <h4>TITA LÓPEZ</h4>
                    <h5 className="subtitle">BAILARINA / DIRECTORA / PROFESORA / PRODUCTORA</h5>

                    <div className="flex-box-half">
                      <div className="one-half-flex" id="no-padding">
                        <p className="text padding-text-right" id="first-paragraph">Inició sus estudios de danza a los 5 años de edad. Tiene una trayectoria de 28 años en el ámbito de la danza. Representó a Panamá por 8 años consecutivos en competencias de danza internacionales obteniendo numerosos premios.</p>
                      ...
                      <div className="one-half-flex" id="no-padding">
                        <p className="text padding-text-left" id="first-paragraph">Fue invitada para bailar representando a Texas Christian University (TCU) en el American College Dance Festival Association (ACDFA) en el Kennedy Center, Washington D.C en mayo 2010.</p>
